...
<style>
  ...
  .login-box {
    ...
    border-radius: 10px;
    animation: moveSLide ease-in-out 1s;
  }
...
<div class="login-box">
  ...
  <div class="custom-control custom-checkbox">
    <?php echo $form->checkBox($model, 'rememberMe', ['class' => 'custom-control-input', 'id' => 'rememberMe']); ?>
    <?php echo $form->label($model, 'rememberMe', ['class' => 'custom-control-label', 'for' => 'rememberMe']); ?>
  ...
  <div class="row buttons">
    <button type="submit" class="custom-button">
      ...
      <span></span>
      <span></span>
      <?php echo CHtml::submitButton('Login', array('class' => 'transparent-button')); ?>
    </button>
  </div>

  <div class="text-info">
    Ingin Daftar ? Silahkan <?php echo CHtml::link('Daftar Akun', array('/site/signup'), array('class' => 'btn btn-outline-light ml-2')); ?>
  </div>
