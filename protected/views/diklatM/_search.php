    ...
    <div class="card"> <!-- Menggunakan Card untuk menampilkan form -->
        <div class="card-body">
			<?php $form=$this->beginWidget('CActiveForm', array(
				...
				<div class="form-group row">
					<?php echo $form->label($model,'nama_diklat', array('class' => 'col-md-4 col-form-label')); ?>
					<div class="col-md-10">
						<?php echo $form->textField($model,'nama_diklat', array('class' => 'form-control inputPesertaId rounded'),array('size'=>60,'maxlength'=>100)); ?>
					</div>
				</div>

				<div class="form-group row">
					<?php echo $form->label($model,'tanggal_mulai', array('class' => 'col-md-4 col-form-label')); ?>
					<div class="col-md-10">
						<?php echo $form->textField($model,'tanggal_mulai', array('class' => 'form-control inputPesertaId rounded')); ?>
					</div>
				</div>

				<div class="form-group row">
					<?php echo $form->label($model,'tanggal_selesai', array('class' => 'col-md-4 col-form-label')); ?>
					<div class="col-md-10">
						<?php echo $form->textField($model,'tanggal_selesai', array('class' => 'form-control inputPesertaId rounded')); ?>
					</div>
				</div>
